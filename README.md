...
4. `SESSION_STRING` : Generate From here [![GenerateStringName](https://img.shields.io/badge/repl.it-generateStringName-yellowgreen)](https://replit.com/@FilesHome/Generate-Telegram-String-Session?v=1)
...
```sh
git clone https://github.com/NiranjanVRam/VCPlayerBot
cd VCPlayerBot
